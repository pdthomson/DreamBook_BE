...
blog1 = Blog.create(title: 'dream about code', body: 'has a dream about code that can fix a bug and it worked!', user_id: 1, status: 0)
...
blog3 =Blog.create(title: 'Exotic Colors', body: 'all of my dreams have vibrant colors', user_id: 2, status: 0)
